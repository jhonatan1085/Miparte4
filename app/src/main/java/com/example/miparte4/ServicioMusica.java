    ...
    public int onStartCommand(Intent intenc, int flags, int idArranque) {
       // NotificationCompat.Builder notific = new NotificationCompat.Builder(this,NOTIFICATION_CHANNEL_ID)
        ...
        NotificationCompat.Builder notific = new NotificationCompat.Builder(this,NOTIFICATION_CHANNEL_ID)
                ...
                .setNumber(4)
                .setAutoCancel(true)
                .addAction(android.R.drawable.ic_menu_call, "llamar", intencionPendienteLlamar)//versiones 7 inferirores
                .addAction(android.R.drawable.ic_menu_call, "Contestar", intencionPendienteLlamar)
                .addAction(android.R.drawable.ic_menu_call, "Salir", intencionPendienteLlamar)
                .setSubText("más info");
